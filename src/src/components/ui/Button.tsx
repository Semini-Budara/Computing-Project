...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-scarlet text-white shadow hover:bg-scarlet/90',
        destructive:
        'bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90',
        outline:
        'border border-fedora/30 bg-transparent shadow-sm hover:bg-concrete hover:text-tuatara',
        secondary: 'bg-fedora/10 text-tuatara shadow-sm hover:bg-fedora/20',
        ghost: 'hover:bg-concrete hover:text-tuatara',
